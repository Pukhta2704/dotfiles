...
(gtk_accel_path "<Actions>/terminal-window/undo-close-tab" "<Alt>e")
(gtk_accel_path "<Actions>/terminal-window/set-title" "<Alt>r")
...
(gtk_accel_path "<Actions>/terminal-window/new-tab" "<Alt>w")
